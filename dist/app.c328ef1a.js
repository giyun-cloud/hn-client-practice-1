...
function newsFeed() {
  ...
  newsList.push("</ul>");
  newsList.push("\n    <div>\n      <a href='#/page/".concat(store.currentPage > 1 ? store.currentPage - 1 : 1, "'>\uC774\uC804 \uD398\uC774\uC9C0<a/>\n      <a href='#/page/").concat(store.currentPage < newsFeed.length / 10 ? store.currentPage + 1 : Math.ceil(newsFeed.length / 10), "'>\uB2E4\uC74C \uD398\uC774\uC9C0<a/>\n    </div>\n  "));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7690" + '/');
